...
ts_mld_pco2_ngs %>% 
  vroom_write(here::here("data/_merged_data_files/", file = "gt_mld_fm_pco2_ngs.csv"))
```
...
ts_mld_pco2_hov %>% 
vroom_write(here::here("data/_merged_data_files/", file = "ts_mld_pco2_hov.csv"))
```
...
rm(ts_pvo2_hov, comparison_ts_mld_pco2_hov, ts_mld_pco2_hov)
```
