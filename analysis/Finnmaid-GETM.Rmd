...
SST_GETM_whole %>% 
  write_csv(here::here("data/_summarized_data_files/", file = paste("GETM_", var, "_whole.csv")))

print(paste("GETM_", var, "_whole.csv")) # to see working progress

rm(SST_GETM_whole, n, file, time_units, var)
}

rm(a, filesList_2d, var_all)
# if not working try with 'cat(paste(out, collapse = '\n'))'
```
