...
### Daily GETM mld
```{r hovmoeller_mld, fig.asp=5, fig.cap="Daily mean GETM mld values as a function of time and the ships distance to Travemuende along route E."}
...
rm(ts_mld_pco2_full_hov_2_naremove, ts_mld_pco2_full_hov_2)
